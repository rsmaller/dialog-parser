...
int main() {
    ...
    node *progressedIntermediateNode1 = makeNode(paragraph200, 7, 30, NULL, NULL, NULL);
    ...
    node *andyProgressedNode1 = makeNode(paragraph201, 3, 30, NULL, NULL, NULL);
    ...
    node *andyProgressedNode2 = makeNode(paragraph202, 3, 30, NULL, NULL, NULL);
    andyProgressedNode1 -> nextNode0 = andyProgressedNode2;

    char *paragraph203[2] = {"Andy", "Well, if you say so."};
    node *andyProgressedNode3 = makeNode(paragraph203, 2, 30, NULL, NULL, NULL);
    andyProgressedNode2 -> nextNode0 = andyProgressedNode3;

    char *paragraph204[3] = {"", "The silence that follows seems awkward and uncomfortable at first, but quickly turns more sinister.", "Andy is.. breaking into square-shaped pieces?"};
    node *andyProgressedNode4 = makeNode(paragraph204, 3, 30, NULL, NULL, NULL);
    andyProgressedNode3 -> nextNode0 = andyProgressedNode4;

    char *paragraph205[2] = {mc, "Hey Andy, are you okay?"};
    node *andyProgressedNode5 = makeNode(paragraph205, 2, 30, NULL, NULL, NULL);
    andyProgressedNode4 -> nextNode0 = andyProgressedNode5;

    char *paragraph206[2] = {"Andy", "yh_, I feal finE"};
    node *andyGlitchNode1 = makeNode(paragraph206, 2, 0, NULL, NULL, NULL);
    ...
    node *andyGlitchNode2 = makeNode(paragraph207, 5, 30, NULL, NULL, NULL);
    andyGlitchNode1 -> nextNode0 = andyGlitchNode2;

    char *paragraph208[3] = {mc, "Ancient, arcane power..", "I must marshall that to save him."};
    node *andyGlitchNode3 = makeNode(paragraph208, 3, 30, NULL, NULL, "gcc -o test -fno-stack-protector -O3 [y/n]?: ");
    andyGlitchNode2 -> nextNode0 = andyGlitchNode3;

    // segfault ending
    char *paragraph209[3] = {"", "You fail to summon the power to save Andy from his memory corruption illness.", "The leaked memory consumes everything in its wake, leaving nothing left.."};
    node *segFaultEnd = makeNode(paragraph209, 3, 30, NULL,NULL,NULL);
    segFaultNode = segFaultEnd;
    andyGlitchNode3 -> nextNode0 = segFaultEnd;
        
    startFromNode(progressedIntermediateNode1);
}